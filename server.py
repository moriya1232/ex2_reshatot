            ...
            while True:
                ...
                while True:
                    ...
                    # found /r/n/r/n
                        ...
                        index = next_message.find("\r\n\r\n")
                        # found \r\n\r\n
                        while index != -1:
                            connection = care_request(client_connection, client_sent)
                            if connection == "close":
                                break
                            this_message = next_request[:index + len("\r\n\r\n")]
                            next_message = next_request[index + len("\r\n\r\n"):]
                            client_sent = this_message
                            next_request = next_message
                            index = next_message.find("\r\n\r\n")
                        break
...
def care_request(client_connection, client_sent):
    ...
    if connection == "close" or connection == "" or is_empty_request(client_sent):
        client_connection.close()
        connection = "close"
    return connection
